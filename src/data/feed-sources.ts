...
export const feedSources: FeedSource[] = [
  ...
  {
    id: "tagesschau-finanzen",
    name: "Tagesschau · Finanzen",
    category: "wirtschaft",
    ...
    status: "active",
    language: "de",
    notes: "Offizieller kostenloser Tagesschau-Feed für Börsen-, Aktien- und Marktberichte.",
  },
  {
    id: "tagesschau-technologie",
    name: "Tagesschau · Technologie",
    category: "wirtschaft",
    ...
    status: "active",
    language: "de",
    notes: "Offizieller kostenloser Tagesschau-Feed für Technologie-, KI- und große Tech-Themen.",
  },
  {
    id: "ecb-press",
